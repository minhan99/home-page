        ...
        <List className="Sub-Menu-Body">
          <ListItem>
            <ListItemButton>
              <ListItemIcon
                sx={{ marginLeft: "255px" }}
                className="Icon-Close-SubMenu"
              >
                <CancelIcon
                  onClick={closeDrawerSubMenu}
                  sx={{ color: "#FF4A52" }}
                  fontSize="large"
                ></CancelIcon>
              </ListItemIcon>
          ...
          <ListItem className="Item-Sub-Menu">
            <ListItemButton>
              <ListItemText className="Text-Sub-Menu">
                Destinations
              </ListItemText>
            </ListItemButton>
          </ListItem>
          ...
          <Box sx={{ marginTop: "75px", bgcolor: "rgba(255,255,255,.85)" }}>
            <Box
              className="Img-Sub-Menu"
              style={{ backgroundImage: `url(${imageURL1})` }}
            >
              <Box className="Img-Sub-Menu-Price">
                <Box sx={{ padding: "0 10px 0 10px" }}>
                  <Box component="span"></Box>$3,900
                </Box>
              </Box>
              <Typography variant="h5" className="Img-Sub-Menu-Name">
                Swiss Alps Trip
              </Typography>
            ...
            >
              <Box className="Img-Sub-Menu-Price">
                <Box sx={{ padding: "0 10px 0 10px" }}>
                  <Box component="span">$4,900</Box>$4,200
                </Box>
              </Box>
              <Typography className="Img-Sub-Menu-Name" variant="h5">
                5 Lake of Fuji San
              </Typography>
              <Box className="Img-Sub-Menu-Rate">
                <StarRateIcon></StarRateIcon>
